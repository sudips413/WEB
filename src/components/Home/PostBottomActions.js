    ...
    <div className='container' >
        <div className='row'>
         <div className="post post-public-actions mt-2">
            ...
            }}><i className="fa fa-heart-o"/>  0 Likes</span>
        ...
        <div className='post post-public-comments ml-3'>
            <button className={`btn btn-show-comment btn-show-comments-${index}`} onClick={()=>{
                handleDisplayClick();
            }}>{showComments? <span>Hide Comment</span>:<span>show Comments</span>}</button>
